...
const Documents = () => {
  ...
  const [documents, setDocuments] = useState([
    ...
    },
    {
      ...
      nlpAnalysis: {
        ...
        summary: 'මාසික 25000 රුපියල් කුලියට 6 මාස කාලයක් සඳහා වලංගු කුලී ගිණුම',
  ...
  const filteredDocuments = documents.filter(doc => {
    ...
    if (statusFilter !== 'all') matchesFilter = matchesFilter && doc.status === statusFilter;
  ...
  const stats = [
    { label: 'මුළු ලේඛන', value: documents.length, icon: FileText, color: 'text-blue-600' },
    { label: 'සත්‍යාපිත', value: documents.filter(d => d.status === 'verified').length, icon: CheckCircle, color: 'text-green-600' },
    { label: 'AI විශ්ලේෂණය', value: documents.filter(d => d.nlpAnalysis).length, icon: Cpu, color: 'text-purple-600' },
    { label: 'මෑත කාලීන', value: documents.filter(d => Date.now() - d.uploadDate < 86400000 * 7).length, icon: TrendingUp, color: 'text-orange-600' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {showUpload && (
          ...
          >
            <Card>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">නව ලේඛනයක් උඩුගත කරන්න</h2>
              ...
              <form onSubmit={handleFileUpload} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-purple-400 transition-colors bg-gradient-to-br from-gray-50 to-purple-50/30">
                    ...
                    <label htmlFor="file" className="cursor-pointer">
                      <span className="text-lg font-medium text-purple-600 hover:text-purple-500">ලේඛනය තෝරන්න</span>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-xl p-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-purple-800 mb-2">සිංහල NLP විශ්ලේෂණය</h4>
                      <p className="text-purple-700 leading-relaxed">
                        ඔබේ ලේඛනය උඩුගත කිරීමෙන් පසු, අපගේ AI පද්ධතිය සිංහල භාෂාවේ 
                        අන්තර්ගතය විශ්ලේෂණය කර වැදගත් තොරතුරු නිස්සාරණය කරයි.
                      </p>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600 text-sm mb-1">{getDocumentTypeLabel(document.type)} • {document.propertyId}</p>
          ...
          <div className="xl:col-span-1">
            <div className="sticky top-8">
              {selectedDocument ? (
                ...
                >
                  <Card>
                    <h2 className="text-xl font-semibold text-gray-900 mb-6">ලේඛන විස්තර</h2>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <span className="ml-2 font-medium">{selectedDocument.id}</span>
                          </div>
                          <div>
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900 mb-2">ලේඛන තොරතුරු</h4>
                        <div className="grid grid-cols-1 gap-2 text-sm">
                          <div>
                            <span className="text-gray-600">වර්ගය:</span>
                            <span className="ml-2">{getDocumentTypeLabel(selectedDocument.type)}</span>
                          </div>
                          <div>
                            <span className="text-gray-600">ඉඩම් ID:</span>
                            <span className="ml-2">{selectedDocument.propertyId}</span>
                          </div>
                          <div>
                            <span className="text-gray-600">උඩුගත දිනය:</span>
                            <span className="ml-2">{formatDate(selectedDocument.uploadDate)}</span>
                          </div>
                          <div>
                      ...
                      {selectedDocument.nlpAnalysis && (
                        <div>
                          ...
                          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-lg p-4 space-y-3">
                            <div>
                              <span className="text-sm text-purple-700 font-medium">සාරාංශය:</span>
                              <p className="text-sm text-purple-600 mt-1">{selectedDocument.nlpAnalysis.summary}</p>
                            </div>
                            
                            <div>
                              <span className="text-sm text-purple-700 font-medium">හඳුනාගත් ආයතන:</span>
                              <div className="mt-1 space-y-1">
                                {selectedDocument.nlpAnalysis.entities.map((entity: any, index: number) => (
                            ...
                            <div>
                              <span className="text-sm text-purple-700 font-medium">මූල පද:</span>
                              <div className="mt-1 flex flex-wrap gap-1">
                                {selectedDocument.nlpAnalysis.keywords.map((keyword: string, index: number) => (
                            ...
                            <div>
                              <span className="text-sm text-purple-700 font-medium">විශ්වසනීයත්වය:</span>
                              <span className="ml-2 text-sm text-purple-600">
                                {(selectedDocument.nlpAnalysis.confidence * 100).toFixed(1)}%
                              </span>
                            </div>
                          </div>
                        </div>
                ...
                <Card>
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">ලේඛනයක් තෝරන්න</h3>
